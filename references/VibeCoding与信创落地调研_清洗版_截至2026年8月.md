# Vibe Coding / AI Coding 工具与信创私有化落地调研 · 清洗版（截至 2026 年 8 月）
...
> 清洗说明（2026-08-30 修订，原文件保留）：
> ① 红线一：已移除全部 CSDN（csdn.net）来源共 **8 条**。能以官方/权威来源替代的已替换（OpenAI 官方文档、GitHub 官方仓库、BAAI FlagEmbedding、Nomic 官方模型页、ModelScope、DeepSeek-OCR 官方仓库、麒麟软件生态适配认证中心等）；无法以官方核实替代的经验帖已删除并标注"**已删（原为 CSDN）**"。
> ② 红线二：对 2025-11 及更早的合规法规、芯片型号、OS 版本、模型适配等条目标注"**⚠️信息较早，落地前核验最新**"并给出可核验官方入口；现行法规类条目注明"截至 2026-08 仍为现行有效法规，以官方现行版本为准"。
> ③ 经验帖/厂商博客类信息一律标注"**经验表述**"；纯营销/测算数字（市场规模、现货量等）标注"**⚠️行业测算/待核验**"。
> ④ 本报告基于搜索引擎返回的标题、摘要与可确认的官方页面整理；个别精确数值未能从摘要直接核验，已逐条标注"待核验"，落地前请按官方页面核对。

---

## 0. 关键时间线速览（2025-02 ~ 2026-08）

> 说明：本节为已发生事件的**历史记录**（事件发生日期即锚点），非需"保持最新"的现状数据；其中 2025-11 及更早的事件条目如有后续进展，以标注的官方入口核验。
...
| 2026-04-24 | DeepSeek V4 预览版发布并开源；后续报道称昇腾超节点等国产芯片同步适配 | ✅ [广州日报大洋网（2026-04-24）](https://news.dayoo.com/finance/202604/24/171077_54952016.htm)；⚠️ [澎湃：昇腾超节点支持 DeepSeek V4](https://m.thepaper.cn/newsDetail_forward_33044189)；✅ [华为官网：昇腾超节点产品页（Atlas 900 A3 SuperPoD）](https://e.huawei.com/cn/products/computing/ascend/atlas-900-a3-superpod) |
...
| 2026-07-26 | 开源终端编程 agent opencode（sst/opencode）改名 Anomaly 并发布 v1.18.5 | ✅ [官方仓库 sst/opencode（GitHub）](https://github.com/sst/opencode)；⚠️ [oday-bakkour 博客（2026-07-26）](https://oday-bakkour.com/blog/ai-coding-news-july-26-2026) |
...
| **OpenAI Codex** | 云端平台 + CLI（开源） | OpenAI 编程 Agent：云端沙箱自动改代码、跑测试、提 PR；CLI 面向终端 | Codex CLI（`codex`）、云端任务 | 2025-04-16 开源 Codex CLI；2025-05 前后上线云端平台（"AI 程序员"）；2026 持续更新（2026-04 平台更新；报道称 Codex 开始"反杀"Claude Code） | ✅ [TechCrunch（2025-04-16）](https://techcrunch.com/2025/04/16/openai-debuts-codex-cli-an-open-source-coding-tool-for-terminals/)；⚠️ [36氪：Codex 是否反超 Claude Code](https://eu.36kr.com/zh/p/3950425889019785)；⚠️ [钛媒体同题报道](https://www.tmtpost.com/8112879.html)；✅ [OpenAI 官方 Codex Manual（developers.openai.com）](https://developers.openai.com/codex/codex-manual.md)；⚠️ [澎湃：Codex 非码农也能用（2026）](https://m.thepaper.cn/newsdetail_forward_33296711)；已删（原为 CSDN：grapecity.csdn.net 专栏分析，已由 OpenAI 官方文档替代） |
...
| 要点 | 事实 | 可信度与来源 |
| :--- | :--- | :--- |
...
| 市场格局 | 政府采购标准划定基线：银河麒麟、华为云欧拉（openEuler）、中兴等构建国产 OS 新格局；2026 国产 OS 市场多厂商布局、核心行业深度渗透 | ⚠️ [C114：政府采购标准与国产 OS 格局](http://www.c114.net.cn/industry/68404.html)（媒体转述）；⚠️ [PConline：2026 国产操作系统市场](https://g.pconline.com.cn/x/2135/21351931.html)（媒体转述）；可核验官方入口：✅ [麒麟软件官网](https://www.kylinos.cn/)、✅ [openEuler 开源社区官网](https://www.openeuler.org/) |

### B2.3 国产 AI 芯片与算力（昇腾 / 鲲鹏）

| 要点 | 事实 | 可信度与来源 |
| :--- | :--- | :--- |
| 昇腾硬件 | 华为昇腾产品线含 Atlas 800I A2 推理服务器、Atlas 800T A2 训练服务器、Atlas 900 A3 SuperPoD 超节点等；910B 为较早一代推理卡（⚠️信息较早，具体规格与当前在售型号以华为官网为准） | ✅ [华为官网：Atlas 800I A2 推理服务器](https://e.huawei.com/cn/products/computing/ascend/atlas-800i-a2)；✅ [华为官网：Atlas 900 A3 SuperPoD 超节点](https://e.huawei.com/cn/products/computing/ascend/atlas-900-a3-superpod)；可核验官方入口：✅ 华为昇腾计算产品线（e.huawei.com/cn/products/computing/ascend） |
| 软件栈 | CANN（商用版 8.0.0 文档存在，⚠️版本迭代快，落地前以昇腾官方文档最新版本为准）；MindIE 推理引擎（2.0.RC1、2.3.0 文档存在）；MindIE 支撑 DeepSeek 等大模型部署；SGLang 官方支持昇腾 NPU | ✅ [昇腾社区：CANN 商用版 8.0.0 文档](https://www.hiascend.com/document/detail/zh/canncommercial/800/quickstart/index/index.html)；✅ [昇腾社区：MindIE 2.3.0 文档](https://www.hiascend.com/document/detail/en/mindie/230/index/index.html)；✅ [SGLang 文档：Ascend NPU 支持模型](https://docs.sglang.io/docs/hardware-platforms/ascend-npus/ascend_npu_support_models)；⚠️ [华为开发者论坛：Atlas 800T A2 跑 DeepSeek-R1-Distill（MindIE 部署踩坑）](https://developer.huawei.com/home/forum/ascend/thread-02200221451283408291-1-1.html)（经验表述） |
| 鲲鹏 ARM 服务器 | 中国电信 2026 年 115 亿元国产服务器集采落地，报道称鲲鹏生态占比超 70%；神州数码中标中国移动两年期服务器集采（13.41 亿元，2026-07） | ⚠️ [ZOL：中国电信 115 亿集采鲲鹏占比超 70%](https://dt.zol.com.cn/1204/12046057.html)（媒体转述，金额/占比待核验，以中国电信官方招标公告为准）；⚠️ [金融界：神州数码中标中国移动（2026-07-02）](https://stock.jrj.com.cn/2026/07/02190557673331.shtml)（媒体转述） |
| 国产 AI 芯片格局 | 《2026 中国国产 AI 芯片厂商能力象限》发布：三强领跑（昇腾、海光、寒武纪等）、梯队分化、国产算力进入放量期；行业报告称国产芯片与超节点放量在即 | ⚠️ [信创世界：2026 国产 AI 芯片能力象限（搜狐）](https://www.sohu.com/a/1037424575_711053)（媒体转述）；⚠️ [证券研报：国产芯片与超节点放量在即](http://stockfinance.sina.cn/stock/go.php/paper/reportid/841363985704/index.phtml)（机构研报，待核验）；⚠️ [CET：2026 国产算力芯片推理赛道辨析](https://www.cet.com.cn/itpd/itxw/10505919.shtml) |
...
| 要点 | 事实 | 可信度与来源 |
| :--- | :--- | :--- |
| 终端替换 | 行业文章称"2200 万台区县 PC 待替换、海光/飞腾/麒麟主导市场"（2026）；另有"30% 红线"（下一台发到单位的同方……）等自媒体表述 | ⚠️ [市场报告：信创国产化替代进程（sgpjbg）](https://www.sgpjbg.com/labelsyh/xinchuangguochanhuatidai.html)（⚠️数字待核验，第三方报告站，非官方统计）；⚠️ [什么值得买：30% 红线](https://post.smzdm.com/p/a95g52d0/)（经验表述，自媒体） |
| 行业案例 | 兴业银行完成大数据基础平台全栈信创改造（2026-07）；信创安全产品目录更新（2026） | ⚠️ [移动支付网：兴业银行全栈信创改造（2026-07）](https://www.mpaypass.com.cn/news/202607/10165709.html)（媒体转述，待核验）；⚠️ [中培教育：2026 信创安全产品目录](https://m.zpedu.com/it/xxaq/38348.html)（培训机构整理，经验表述） |

## B3. 国内开源模型（DeepSeek / Qwen）在昇腾 NPU 的适配推进

| 时间/事件 | 事实 | 可信度与来源 |
| :--- | :--- | :--- |
| 2025-02 起 | DeepSeek 系列新模型上线华为昇腾社区（"一键获取，开箱即用"）；华为 ModelEngine 支持 DeepSeek 全系列本地部署 | ⚠️信息较早（2025-02），落地前核验最新；可核验官方入口：✅ [昇腾社区](https://www.hiascend.com/)（模型与适配列表以现行页面为准）；⚠️ [IT之家：DeepSeek 系列上线昇腾社区（2025-02）](https://www.ithome.com/0/828/700.htm)；⚠️ [EEPW：华为 ModelEngine 支持 DeepSeek 全系列（2025-02）](http://m.eepw.com.cn/article/202502/466682.html) |
| 2025 | 华为昇腾 0Day 支持阿里 Qwen3-VL-30B-A3B；"昇腾全系列支持 Qwen3"；昇腾适配 Qwen3.6 | ⚠️信息较早（2025），落地前以昇腾社区现行适配列表为准；✅ [昇腾官网：适配 Qwen3.6 新闻](https://www.hiascend.com/zh/activities/dynamic-news/677)（官方发布页）；⚠️ [IT之家：昇腾 0Day 支持 Qwen3-VL-30B-A3B](https://m.ithome.com/html/887564.htm)；⚠️ [中国证券网：昇腾全系列支持 Qwen3](https://www.cnstock.com/commonDetail/429414) |
| 2026-04-24 | DeepSeek V4 发布并开源，报道称"八家国产芯片与 NVIDIA 全面适配，性能提升近 2 倍"；华为宣布昇腾超节点系列产品全系支持 DeepSeek V4 | ✅ [华为官网：Atlas 900 A3 SuperPoD 超节点（昇腾超节点产品页）](https://e.huawei.com/cn/products/computing/ascend/atlas-900-a3-superpod)；⚠️ [澎湃：昇腾超节点支持 DeepSeek V4，寒武纪也适配完成](https://m.thepaper.cn/newsDetail_forward_33044189)；⚠️ [IT之家：昇腾超节点全面支持 DeepSeek V4](https://www.ithome.com/0/943/029.htm)；⚠️ [expreview：华为宣布昇腾超节点全系支持 DeepSeek V4](https://www.expreview.com/105466.html)（"八家/近 2 倍"为媒体口径⚠️待核验，以官方发布为准） |
...
| 行业落地 | 政企"AI+政务"：地方政府接入 DeepSeek（赛意信息，⚠️信息较早 2025，厂商案例，经验表述）；智子芯元 38 分钟完成 DeepSeek 昇腾平台部署（深圳发改委转载，2026） | ✅ [深圳市发改委：38 分钟部署 DeepSeek 昇腾（2026）](https://fgw.sz.gov.cn/ztzl/qtztzl/szscjmyjjfzzhfwpt/mqfc/myqyfzdt/content/post_12691408.html)（政府官网转载）；⚠️ [赛意信息：地方政府接入 DeepSeek 智慧政务](https://www.chinasie.com/aboutus/829.html)（2025，厂商官网案例，经验表述，落地前核验最新） |
...
| 问题 | 公开佐证 | 可信度 |
| :--- | :--- | :--- |
| 扫描件/复杂版面解析是首要痛点 | 行业文章：文档进 RAG 前必须先做表格结构还原；复杂文档（表格、版面）解析决定问答质量；"文档丢进去就能用？"是伪命题；合合信息《2026 企业知识库建设白皮书》聚焦文档解析 | ⚠️ [合合信息：表格结构还原（2026-06-12）](https://www.textin.com/news/20260612173439634)（厂商技术文章，经验表述）；⚠️ [合合信息：2026 企业知识库建设白皮书](https://www.intsig.com/news/2026qiyezhishikujianshebaipishu)（厂商白皮书）；⚠️ [麓谷云：企业 AI 知识库落地最后一公里](https://www.lumevalley.com/article-6532.html)（经验表述）；⚠️ [澎湃：RAG 准确率先过文档解析这关](https://www.thepaper.cn/newsDetail_forward_33027100)（经验表述） |
| 开源文档解析工具 | MinerU（高精度文档解析引擎，开源；官方 PyPI 包 + 官方仓库 + 官方生态项目） | ✅ [MinerU 官方仓库（opendatalab）](https://github.com/opendatalab/MinerU)；✅ [PyPI mineru](https://pypi.org/project/mineru/3.4.5/)；✅ [MinerU 官方生态（MinerU-Ecosystem）](https://github.com/opendatalab/MinerU-Ecosystem)；已删（原为 CSDN）："MinerU 信创版（麒麟 V10+昇腾 910B）适配实践"经验帖无法从官方核实，已删除；信创环境适配请以官方渠道核验：✅ [麒麟软件生态适配认证中心](https://www.kylinos.cn/eco/ecoQuery/technologyDocument/ecoAdaptation/2001223484177973250.html)、✅ [昇腾社区](https://www.hiascend.com/)（具体适配记录以官方认证为准，⚠️待核验） |
| DeepSeek-OCR 信创案例 | 原条目"DeepSeek-OCR-2 信创环境（麒麟 V10 + 申威 SW64）适配案例"已删（原为 CSDN；"DeepSeek-OCR-2"版本号与申威适配案例未能从官方渠道核实，⚠️待核验） | ✅ [DeepSeek-OCR 官方仓库（deepseek-ai，Contexts Optical Compression）](https://github.com/deepseek-ai/DeepSeek-OCR)；可核验官方入口：✅ [申威官网（申威处理器产品页）](http://www.swcpu.cn/)、✅ [麒麟软件生态适配认证中心](https://www.kylinos.cn/eco/ecoQuery/technologyDocument/ecoAdaptation/2001223484177973250.html)（具体适配以官方认证记录为准） |
...
| 问题 | 公开佐证 | 可信度 |
| :--- | :--- | :--- |
| 中文检索效果/embedding 选型 | 行业文章：企业内部 RAG"用开源模型做 Embedding，结构化内容掉链子"；embedding 模型选型实战（bge 系列等）；中文 RAG 基准 CRUD-RAG（ACM TOIS）公开评测（gte-base 等模型分数） | ⚠️ [合合信息：企业 RAG 结构化内容掉链子（2026-07-10）](https://www.textin.com/news/20260710141545153)（经验表述）；⚠️ [51CTO：Embedding 模型选型与效果优化](https://blog.51cto.com/u_16104640/14872122)（经验表述）；✅ [ACM：CRUD-RAG 中文基准](https://dl.acm.org/doi/full/10.1145/3701228) |
| 国产化/信创 embedding 部署 | 已删（原为 CSDN）："BGE-M3 信创验证报告""nomic-embed-text-v2-moe 信创适配""bge-large-zh-v1.5 容器化部署"三条经验帖无法从官方核实，已删除；模型官方来源如下 | ✅ [BAAI FlagEmbedding 官方仓库（BGE 系列：bge-large-zh-v1.5、BGE-M3 等）](https://github.com/FlagOpen/FlagEmbedding)；✅ [Nomic 官方模型页：nomic-embed-text-v2-moe（Hugging Face）](https://huggingface.co/nomic-ai/nomic-embed-text-v2-moe)；可核验官方入口：✅ [麒麟软件生态适配认证中心](https://www.kylinos.cn/eco/ecoQuery/technologyDocument/ecoAdaptation/2001223484177973250.html)、统信软件官网（uniontech.com，UOS 兼容认证）（具体信创适配以官方认证记录为准，⚠️待核验） |
| 检索提升手段 | 混合检索（Hybrid Search：向量召回 + 关键词召回融合）、重排序（Qwen3-Reranker-0.6B） | ⚠️ [腾讯云：混合检索工程实践](https://cloud.tencent.com.cn/developer/article/2728960)（经验表述）；✅ [Qwen3-Reranker-0.6B 官方模型页（ModelScope）](https://modelscope.cn/models/Qwen/Qwen3-Reranker-0.6B)；✅ [vLLM-Ascend 官方文档：Qwen3-Reranker 昇腾部署教程](https://github.com/vllm-project/vllm-ascend/blob/main/docs/source/tutorials/models/Qwen3_reranker.md)；已删（原为 CSDN）："Qwen3-Reranker 信创麒麟 OS+海光 CPU 适配"经验帖无法从官方核实，已删除（信创适配以官方认证记录为准，⚠️待核验） |

### B4.3 离线交付

| 问题 | 公开佐证 | 可信度 |
| :--- | :--- | :--- |
| 离线/无网环境部署 | LightRAG 官方 Offline Deployment 指南；离线部署中文 embedding（ONNX 实现指南）；nomic-embed 离线环境适配；智能体平台私有化部署（模型、数据、工具与运行环境架构） | ✅ [GitHub HKUDS/LightRAG OfflineDeployment](https://github.com/HKUDS/LightRAG/blob/828d1c01/docs/OfflineDeployment.md)；⚠️ [百度开发者：离线中文 Embedding ONNX 指南](https://developer.baidu.com/article/detail.html?id=7365573)（经验表述）；⚠️ [亿方云：智能体平台私有化部署架构](https://www.filez.com/news/detail/ddd93d97a60d9c51d87b68b91cc53e76.html)（厂商博客，经验表述）；⚠️ [阿里云：AI 本地化部署的技术难点](https://developer.aliyun.com/article/1723868)（经验表述） |
| 一体机交付模式 | 国产 AI 大模型一体机成为政企私有化交付主流载体；报道称"2026 市场规模冲刺 5000 亿"（⚠️行业测算，非官方统计，待核验）；昇腾推出全系列 Claw 一体机（2026，媒体口径，以华为昇腾官方发布为准）；财信证券研报称 1249 亿政企市场（⚠️机构测算） | ⚠️ [iotdt：2026 一体机市场规模冲刺 5000 亿](https://www.iotdt.com/news/xingyezixun/2596.html)（⚠️营销/测算数字，待核验）；⚠️ [CNMO：昇腾全系列 Claw 一体机](https://ai.cnmo.com/news/805357.html)（媒体转述，以昇腾官方发布为准）；⚠️ [财信证券：大模型一体机 1249 亿政企市场](https://www.sgpjbg.com/labelsyh/damoxingyitijitouzijihui.html)（机构测算转载，待核验） |

### B4.4 知识时效 / 增量更新

| 问题 | 公开佐证 | 可信度 |
| :--- | :--- | :--- |
| 知识时效（新鲜度） | 行业文章：企业知识频繁变化，智能体如何保持内容新鲜和答案一致；RAG 进入"实时更新阶段"（网页采集 + 增量索引成为企业 AI 新底座）；知识库过期内容治理（企业本地化部署实践） | ⚠️ [亿方云：企业知识频繁变化如何保鲜](https://www.filez.com/news/detail/581cb7313c1ea2a191e01dfc74728acb.html)（厂商博客，经验表述）；⚠️ [腾讯云：RAG 实时更新与增量索引（2026）](https://cloud.tencent.cn/developer/article/2700328)（经验表述）；⚠️ [阿里云：知识库过期内容如何治理](https://developer.aliyun.com/article/1750481)（经验表述） |
| 增量更新实现 | RAG 向量数据库增量更新方案（ETL 视角）；智能体知识库动态迭代架构与数据集全链路版本管理；腾讯云智能体平台动态知识库更新与版本控制 | ⚠️ [腾讯云：RAG 向量数据库增量更新](https://cloud.tencent.com.cn/developer/article/2645176)（经验表述）；⚠️ [阿里云：智能体知识库动态迭代与版本管理实战](https://developer.aliyun.com/article/1740017)（经验表述）；⚠️ [腾讯云：智能体动态知识库更新与版本控制](https://cloud.tencent.com.cn/developer/article/2566460)（经验表述） |
...
4. **信创数值**：2200 万台 PC 待替换、一体机 5000 亿市场规模、"八家芯片适配、性能近 2 倍"、中国电信 115 亿集采鲲鹏占比 70% 等均为媒体/机构口径（⚠️待核验），教材引用应标注来源与时间点或弱化为定性。
5. **数据跨境**：298 个（2025-04 官方口径）与 285 个（第三方报道）并存，属不同时间点统计，引用时注明出处日期；最新进度以国家网信办官网发布为准。
6. **私有化 RAG 工程问题**：PDF/扫描件 OCR、中文 embedding、离线交付、增量更新四大类问题均有公开经验佐证，但多为"经验表述"级信源，教材应作为工程事实陈述而非统计结论。
7. **清洗记录（2026-08-30）**：a) 全文 8 条 CSDN（csdn.net）来源已全部移除——2 条以官方来源替换（Codex→OpenAI 官方文档、OpenCode→官方 GitHub 仓库），6 条经验帖删除并标注"已删（原为 CSDN）"，同时为模型类条目补充官方仓库（BAAI FlagEmbedding、Nomic、ModelScope、DeepSeek-OCR）；b) 2025-11 及更早条目（数据出境评估统计 2025-04、上海/广东负面清单 2024、金仓 KES V9 2025、DeepSeek 上线昇腾社区 2025-02、昇腾 0Day Qwen3-VL 2025、赛意信息案例 2025 等）已加"⚠️信息较早，落地前核验最新"标注并给出可核验官方入口；c) 现行法规（PIPL、网信办令第 16 号、标准合同办法）注明截至 2026-08 仍为现行有效，以官方现行版本为准。

---

*报告整理时间：2026-08-30（清洗版）。所有 URL 均为检索可得来源，逐条标注可信度与日期；落地使用前请按官方页面核对最新状态。原文件《VibeCoding与信创落地调研_截至2026年8月.md》保留未动。*
