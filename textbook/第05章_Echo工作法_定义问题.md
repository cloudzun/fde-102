...
> **本章定位：** Echo 侧方法论的"知识底座"——教你 Echo 在项目里具体怎么干活。本章是理论，紧接着的实操一（西岭需求调研）马上用到它，两者是"知识 → 动手"的一对。
>
> **建议读者：** 偏 Echo 者精读，偏 Delta 者也需理解（要在施工时看懂 Echo 的方案框架怎么来的）。
>
> **前置：** 第 3 章（四阶段交付）、第 4 章（Echo 角色）。
...
头脑风暴 / 诊断不是"随便聊聊"，而是用三个脚手架让讨论有结构、有产出。
...
> **坐标轴的读法：** 纵轴是"权力高低"（说了算不算），横轴是"兴趣高低"（想不想参与推动）。沿纵轴从上往下 = 权力从高到低；沿横轴从左往右 = 兴趣从低到高。
...
> **坐标轴的读法：** 纵轴是"可行性高低"（数据、技术、合规、周期上好不好做），横轴是"影响力高低"（领导关不关心、业务获得感强不强、覆盖大不大）。沿纵轴从上往下 = 可行性从高到低；沿横轴从左往右 = 影响力从低到高。
...
- **下一章：** 实操一 · 西岭需求调研与《解决方案框架》（把本章方法第一次用到西岭场景）。
