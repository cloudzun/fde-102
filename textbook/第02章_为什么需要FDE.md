...
> **回注资产的种类（教材提炼）：** 回注资产不仅包括代码组件，也包括**对象模型、关系模型、动作模式和治理规则**——业务语义同样是可回注、可复用的资产（第 15 章 15.4 展开）。
...
能力回注带来一个朴素但有力的规律——**经验曲线效应（Experience Curve Effect，源自波士顿咨询总结的行业经验规律）**。本书把它用作解释 FDE"越做越省"的框架（**教材提炼**，非厂商官方公式），其公式为：
...
> [!NOTE]
> **来源与时效性声明：** 本节数据引自 Palantir（NASDAQ: PLTR）**SEC 原始备案**：[S-1 招股书（2020-09，EDGAR）](https://www.sec.gov/Archives/edgar/data/1321655/000119312520244982/d904406ds1.htm) 与历年 **10-K 年报**（[EDGAR 公司档案页](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001321655&type=10-K&dateb=&owner=include&count=40)），**信息截至 FY2025（2026 年 8 月）**。表中数值均为约数（按备案数据计算，各财年服务 / 非服务收入口径拆分不同），精确值以各财年 10-K 原文为准；第三方汇总站（[vcpscanner](https://vcpscanner.com/stock/pltr/financials)、[valueinvesting.io](https://valueinvesting.io/PLTR/metric/gross-margin)）仅作交叉参考，**不替代一手来源**。
...
| :--- | :--- | :--- |
| 2018 | 72.2% | 政府合同与平台订阅结构占比高，毛利自始不低；净亏损主要在人力与研发投入（教材解释假说，财报不披露归因） |
| 2019 | 67.4% | 收入结构变化、现场实施扩张（可能解释，教材提炼） |
| 2020 | 67.3% | 组件复用度提升与收入结构调整并行（可能解释，教材提炼） |
| 2021 | 78.0% | 平台复用扩大、FDE 人效改善（可能解释，教材提炼） |
| 2022 | 78.5% | 本体 / 语义层复用扩大、实施效率改善（可能解释，教材提炼） |

毛利率 2018–2020 已站稳 67–72% 高位——**远高于外包的 10–30%（见 2.2 对比表），"这不是外包"在起点就成立**；2021 年起进一步爬升至 78.5%（2022），为"飞轮成熟"背书。

> \* 表注：均为 **GAAP 整体毛利率**。2018（430,008/595,409=72.2%）与 2019（500,182/742,555=67.4%）按 **SEC S-1/A 原始利润表**计算；2020（FY，10-K 口径约 67.3%）；2021（1,202/1,542≈78.0%）与 2022（1,497/1,906≈78.5%）按财报数据复算。**驱动因素列为教材解释假说**——财报只披露结果、不披露归因，请勿写成 Palantir 官方归因。GAAP 整体毛利率 ≠ contribution margin ≠ 项目级毛利（见 2.3）≠ 营业利润率（见下阶段表），指标口径不可混用。
