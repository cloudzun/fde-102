...
|---|---|---|---|
| 复用实操二施工工作流 | 10.4 全程 | 启动提示词含 7 项信息 | 含政策文档 + Q&A 验证集 |
| 施工 RAG（解析→分块→向量化→检索→生成+引用） | 10.4.1/10.4.2 | 索引与检索代码、qa_pairs.csv | 5 份文档读全、建索引抽查 |
| 双指标验收落地 | 10.4.3 环节 3 | qa-report.md 双指标结果 | 双指标达标、拒答实测 |
| RAG 特有决策点（切块/top-K/兜底） | 10.4.2 环节 2 | SPEC-决策记录.md | 决策点都拍板 |
| 演示级验收声明 + 交接 | 10.4.3/10.4.4 | 验收声明、retro.md | 声明与交接完成 |
...
|---|---|---|---|---|---|---|
| 10.2 场景 B 双指标口径 | RAG + 引用 + 拒答 | qa-report.md | 演示反馈 | 待填 | 是否调整及原因 | Go / 继续 / 回炉 |
