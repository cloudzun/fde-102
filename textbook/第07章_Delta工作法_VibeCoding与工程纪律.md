...
> **由此引出本书的两种训练模式**（承第 4 章）：Echo 侧实操（Ch6/Ch16）头脑风暴、全程不用 AI，练判断力；Delta 侧实操（Ch8/10/12）用 opencode + gstack，练施工力。**"人会判断、AI 会执行"是 FDE 交付的核心引擎**，本章教 Delta 如何驾驭这一引擎。
