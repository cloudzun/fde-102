...
- **章节地图：** 第 3 章讲了"怎么干活"的方法论，本章确立**由谁来执行**：Echo（靠想）负责前半（需求→施工图，Ch5/6），Delta（靠做）负责后半（施工→Demo，Ch7–12），Ch15 全团队收口。
...
| 训练什么 | 判断力（前脑） | 施工力（后手） |
| 主导实操 | Ch6 需求调研、Ch15 汇报 | Ch8/10/12 三个 Demo 施工、Ch15 技术评估 |
...
> 由此引出本书的**两种训练模式**：
> - **头脑风暴品类（Ch6 实操一、Ch15 实操五）全程不用 AI**——训练判断力，AI 替不了；
...
| 5 | 项目快交，要判断"需求满足了吗、能上生产吗" | **全团队** | 双视角互补，缺一不可（第 15 章） |
